...
--- add 'zig' as valid option to --cc
local opt_cc = premake.option.get('cc')
table.insert(opt_cc.allowed, { "zig", "ZIG Cross-compiler (zig cc/zig c++)" })

--- add 'clang' as valid type to actions
local act_cmake = premake.action.get('cmake')
table.insert(act_cmake.valid_tools.cc, 'zig')

local act_jcdb = premake.action.get('jcdb')
table.insert(act_jcdb.valid_tools.cc, 'zig')

local act_gmake = premake.action.get('gmake')
table.insert(act_gmake.valid_tools.cc, 'zig')

local act_ninja = premake.action.get('ninja')
table.insert(act_ninja.valid_tools.cc, 'zig')

local act_xcode8 = premake.action.get('xcode8')
table.insert(act_xcode8.valid_tools.cc, 'zig')

local act_xcode9 = premake.action.get('xcode9')
table.insert(act_xcode9.valid_tools.cc, 'zig')

local act_xcode10 = premake.action.get('xcode10')
table.insert(act_xcode10.valid_tools.cc, 'zig')
